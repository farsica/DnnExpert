                ...
                <asp:DataGrid ID="extensionsGrid" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" runat="server" GridLines="None" Width="100%" CssClass="dnnGrid">
                    ...
                    <Columns>                      
                        ...
                        <asp:TemplateColumn FooterText="Portal">
                            <HeaderStyle Wrap="False" Width="18px" />
                            <ItemStyle />
                            <ItemTemplate>
                        ...
                        <dnn:textcolumn headerStyle-width="275px" DataField="Description" HeaderText="Description"  ItemStyle-CssClass="dnnGridHeaderTD-Border" />
