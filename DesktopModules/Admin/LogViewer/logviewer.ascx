			...
			<asp:Repeater EnableViewState="False" runat="server" ID="dlLog">
				...
				<ItemTemplate>
					<div class='dnnLogItemHeader'>
					    <div style="width:50px" class="dnnLogItemHeaderIndicator">
                            ...
                            <span class="<%# GetMyLogType(DataBinder.Eval(Container.DataItem,"LogTypeKey").ToString()).LogTypeCSSClass %>"></span>
					    </div>
