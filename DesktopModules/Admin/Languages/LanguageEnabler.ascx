            ...
            <dnn:DnnGrid ID="languagesGrid" runat="server" AutoGenerateColumns="false" Width="900px">
                <MasterTableView>
                    ...
                    <Columns>
                        ...
                        <dnn:DnnGridTemplateColumn ItemStyle-Width="50px" HeaderStyle-Width="50px">
                            <HeaderTemplate>
                        ...
                        <dnn:DnnGridTemplateColumn>
                            <HeaderTemplate>
                                <table cellspacing="0" class="DnnGridNestedTable">
                                    <caption>
                                    ...
                                    <tbody>
                                        <tr>
                                            <%
                                                ...
                                                {%>
                                            <td id="Td2" style="width: 100px;" runat="server">
                                                <%# Localization.GetString("System", this.LocalResourceFile)%>
                                            </td>
                                            <td id="Td1" style="width: 100px;" runat="server">
                                    ...
                                    <table cellspacing="0" class="DnnGridNestedTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                {
                                                %>
                                                <td id="Td4" style="width: 100px; border-width: 0px">
                                                ...
                                                <td id="Td3" style="width: 100px;" runat="server">
