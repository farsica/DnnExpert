	...
	<tr>
		<td>
			<table cellspacing="1" cellpadding="1" style="width:100%;">
				<tr>
					<td style="vertical-align:middle; width:33%; white-space: nowrap;">
					...
					<td style="vertical-align:middle; white-space: nowrap; width:33%;">
							    ...
							    <tr>
								    <td align="center">
									    <table cellspacing="1" cellpadding="0" border="0">
							                <tr style="vertical-align:bottom">
											    <td class="SubHead" style="white-space: nowrap;"><asp:Label ID="lblModule" Runat="server" CssClass="SubHead" enableviewstate="False" />&nbsp;</td>
											    ...
											    <td class="SubHead" style="white-space: nowrap;"><asp:Label ID="lblPane" Runat="server" CssClass="SubHead" enableviewstate="False" />&nbsp;</td>
							                ...
							                <tr style="vertical-align:bottom">
											    <td class="SubHead"  style="white-space: nowrap;"><asp:Label ID="lblTitle" Runat="server" CssClass="SubHead" enableviewstate="False"/>&nbsp;</td>
											    <td style="white-space: nowrap;">
											    ...
											    <td class="SubHead" style="white-space: nowrap;"><asp:Label ID="lblPosition" Runat="server" CssClass="SubHead" resourcekey="Position" enableviewstate="False" />&nbsp;</td>
											    <td style="white-space: nowrap;">
												    <asp:dropdownlist id="cboPosition" runat="server" CssClass="NormalTextBox" Width="120" AutoPostBack="true"/>&nbsp;&nbsp;
											    </td>
										    </tr>
							                <tr style="vertical-align:bottom">
											    <td class="SubHead" style="white-space: nowrap;"><asp:Label ID="lblPermission" Runat="server" CssClass="SubHead" resourcekey="Permission" enableviewstate="False" />&nbsp;</td>
											    <td style="white-space: nowrap;">
											    ...
											    <td class="SubHead" style="white-space: nowrap;"><asp:Label ID="lblInstance" Runat="server" CssClass="SubHead" enableviewstate="False" resourcekey="Instance" /></td>
											    <td style="white-space: nowrap;">
