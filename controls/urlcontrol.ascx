...
<div class="urlControl">
    ...
    <div class="dnnClear">
        <asp:CheckBox ID="chkTrack" resourcekey="Track" runat="server" Text="Track?" />
        <asp:CheckBox ID="chkLog" resourcekey="Log" runat="server" Text="Log?" />
        <asp:CheckBox ID="chkNewWindow" resourcekey="NewWindow" runat="server" Text="New Window?" Visible="False" />
    </div>
</div>
