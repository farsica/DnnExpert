...
<head runat="server">
    ...
    <link id="InstallStylesheet" runat="server" rel="stylesheet" type="text/css" href="Install.css?refresh" />    
     <!--[if IE]>
	<link id="IeStylesheet" runat="server" rel="stylesheet" type="text/css" href="../Portals/_default/ie.css?refresh" />
    <![endif]-->
...
<body>
    ...
    <div id="languageFlags" style="float: right;">
        <asp:LinkButton  id="lang_fa_IR" class="flag" runat="server" value="fa-IR" title="فارسي (ايران)" OnClientClick="installWizard.changePageLocale('lang_fa_IR','fa-IR');" CausesValidation="false"><img src="../images/flags/fa-IR.gif" alt="fa-IR" class="flagimage"/></asp:LinkButton>
