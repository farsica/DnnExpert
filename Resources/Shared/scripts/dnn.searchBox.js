    ...
    $.dnnSearchBox.prototype = {
        ...
        _generateTemplate: function () {
            ...
            if (advancedEnabled) {
                ...
                if (rtl) {
                    q.hide().css({ left: w + 30 });
                    a.css({ left: w + 38 });
                }
                else {
                    q.hide().css({ right: w + 30 });
                    a.css({ right: w + 38 });
                }
            }
            //fariborz khosravi
            if (rtl) {
                ...
                if (originalVal) {
                    this.realInput.next().addClass('dnnShow').css({ left: realInputRight - 15 });
                }
            }
            else {
                this.realInput.css({ right: realInputRight });
                if (originalVal) {
                    this.realInput.next().addClass('dnnShow').css({ right: realInputRight - 15 });
                }
            }
            this.realInput.css({ width: wrapWidth - realInputRight - 8 });
        },    
            ...
            realInput.on('keyup', function (e) {
                ...
                if (!val) {
                    ...
                    if ($(document.body).css("direction") == "rtl") {
                        ...
                        clearTextBtn.css({ right: right });
                    }
                    clearTextBtn.addClass('dnnShow');
